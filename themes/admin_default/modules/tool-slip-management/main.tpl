...
<div class="row g-3">
    <div class="col-lg-6 col-md-6">
        ...
        <div class="text-muted small text-uppercase fw-bold">{LANG.total_tools}</div>
        <div class="d-block"><i class="fas fa-tools fa-2x tsm-icon-total"></i></div>
        </div>
        </div>
        <div class="stat-number d-flex align-items-center justify-content-end fw-bold">{TOTAL_TOOLS}</div>
        </div>
        </div>
        </a>
    </div>
    ...
    <div class="col-lg-6 col-md-6">
        ...
        <div class="stat-left d-flex align-items-center">
        <div class="me-3 text-start">
        <div class="text-muted small text-uppercase fw-bold">{LANG.available_tools}</div>
        <div class="d-block"><i class="fas fa-check-circle fa-2x tsm-icon-available"></i></div>
        </div>
        </div>
        <div class="stat-number d-flex align-items-center justify-content-end fw-bold">{AVAILABLE_TOOLS}</div>
        </div>
        </div>
        </a>
    </div>
    ...
    <div class="col-lg-6 col-md-6">
        ...
        <div class="stat-left d-flex align-items-center">
        <div class="me-3 text-start">
        <div class="text-muted small text-uppercase fw-bold">{LANG.borrowed_tools}</div>
        <div class="d-block"><i class="fas fa-hand-holding fa-2x tsm-icon-borrowed"></i></div>
        </div>
        </div>
        <div class="stat-number d-flex align-items-center justify-content-end fw-bold">{BORROWED_TOOLS}</div>
        </div>
        </div>
        </a>
    </div>
    ...
    <div class="col-lg-6 col-md-6">
        ...
        <div class="stat-left d-flex align-items-center">
        <div class="me-3 text-start">
        <div class="text-muted small text-uppercase fw-bold">{LANG.overdue_slips}</div>
        <div class="d-block"><i class="fas fa-exclamation-triangle fa-2x tsm-icon-overdue"></i></div>
        </div>
        </div>
        <div class="stat-number d-flex align-items-center justify-content-end fw-bold">{OVERDUE_SLIPS}</div>
        </div>
        </div>
        </a>
    </div>
